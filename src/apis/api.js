...
export const fetchDynamicButton = async (instId) => {
  const response = await fetch('http://35.244.8.93:3000/Get_dynamic_button', {
    method: 'POST',
    body: new URLSearchParams({
      id: instId,
      key: apiKey
...
export const fetchFAQ = async (instId) => {
  const response = await fetch('http://35.244.8.93:3000/Get_Faq/', {
    method: 'POST',
    body: new URLSearchParams({
      id: instId,
      key: apiKey
...
export const fetchAchievement = async (instId) => {
  const response = await fetch('http://35.244.8.93:3000/Get_students_achievements/', {
    method: 'POST',
    body: new URLSearchParams({
      id: instId,
      key: apiKey
...
export const sendCareerData = async (data) => {
  ...
  const response = await fetch('http://35.244.8.93:3000/careerform', {
    method: 'POST',
    body: data
  })
  return response.json();
...
export const sendFranchiseData = async (data) => {
  data['key'] = apiKey;
  // data['id']=instId;
  const response = await fetch('http://35.244.8.93:3000/contact_franchise', {
    method: 'POST',
    body: new URLSearchParams(data)
  })
  return response.json();
